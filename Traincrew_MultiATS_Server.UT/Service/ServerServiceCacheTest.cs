...
public class ServerServiceCacheTest
{
    private static (ServerService service, Mock<IServerRepository> repoMock, IMemoryCache cache) CreateService()
    {
        ...
        var schedulerManagerForServer = new SchedulerManagerForServer(scopeFactoryMock.Object, mutexMock.Object);
        var cache = new MemoryCache(new MemoryCacheOptions());
        var service = new ServerService(repoMock.Object, schedulerManagerForServer, mutexMock.Object, cache);
