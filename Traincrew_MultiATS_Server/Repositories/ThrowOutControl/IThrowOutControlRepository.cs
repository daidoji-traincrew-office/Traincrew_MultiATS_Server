...
public interface IThrowOutControlRepository
{
    ...
    Task<List<Models.ThrowOutControl>> GetBySourceIds(List<ulong> sourceIds, List<ThrowOutControlType> controlTypes);
    Task<List<Models.ThrowOutControl>> GetByTargetIds(List<ulong> targetIds);
    Task<List<Models.ThrowOutControl>> GetByTargetIds(List<ulong> targetIds, List<ThrowOutControlType> controlTypes);
