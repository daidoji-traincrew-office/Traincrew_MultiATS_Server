...
public interface IDiscordService
{
    ...
    Task<SocketGuildUser?> GetMemberById(ulong memberId);
}
    ...
    EnableAuthorizationStore enableAuthorizationStore) : IDiscordService
{
    ...
    public async Task<SocketGuildUser?> GetMemberById(ulong memberId)
    {
        return await discordRepository.GetMember(memberId);
    }
