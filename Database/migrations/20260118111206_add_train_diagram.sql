...
CREATE TABLE "train_diagram" ("id" bigserial NOT NULL, "dia_id" integer NOT NULL, "train_number" character varying(100) NOT NULL, "train_type_id" bigint NOT NULL, "from_station_id" character varying(10) NOT NULL, "to_station_id" character varying(10) NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "train_diagram_from_station_id_fkey" FOREIGN KEY ("from_station_id") REFERENCES "station" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "train_diagram_to_station_id_fkey" FOREIGN KEY ("to_station_id") REFERENCES "station" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "train_diagram_train_type_id_fkey" FOREIGN KEY ("train_type_id") REFERENCES "train_type" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
