...
CREATE TABLE "train_state" ("train_number" character varying(100) NOT NULL, "from_station_id" character varying(10) NOT NULL, "to_station_id" character varying(10) NOT NULL, "delay" integer NOT NULL DEFAULT 0, "is_driving" boolean NOT NULL DEFAULT true, PRIMARY KEY ("train_number"), CONSTRAINT "train_state_from_station_id_fkey" FOREIGN KEY ("from_station_id") REFERENCES "station" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "train_state_to_station_id_fkey" FOREIGN KEY ("to_station_id") REFERENCES "station" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Create "train_car_state" table
CREATE TABLE "train_car_state" ("train_number" character varying(100) NOT NULL, "index" integer NOT NULL, "car_model" character varying(100) NOT NULL, "has_pantograph" boolean NOT NULL DEFAULT false, "has_driver_cab" boolean NOT NULL DEFAULT false, "has_conductor_cab" boolean NOT NULL DEFAULT false, "has_motor" boolean NOT NULL DEFAULT false, "door_close" boolean NOT NULL DEFAULT true, "bc_press" boolean NOT NULL DEFAULT false, "ampare" integer NOT NULL DEFAULT 0, PRIMARY KEY ("train_number", "index"), CONSTRAINT "train_car_state_train_number_fkey" FOREIGN KEY ("train_number") REFERENCES "train_state" ("train_number") ON UPDATE NO ACTION ON DELETE NO ACTION);
